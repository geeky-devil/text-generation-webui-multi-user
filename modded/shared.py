...
# if args.multi_user:
#     username_arg_help="Since you multi_user is set, provide a username" # extra arg for multi user
#     parser.add_argument("--username",help=username_arg_help,required=True)
