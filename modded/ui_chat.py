    ...
    with gr.Tab('Chat', elem_id='chat-tab', elem_classes=("old-ui" if shared.args.chat_buttons else None)):
                ...
                with gr.Row(elem_id="chat-input-row"):
                    ...
                    with gr.Column(scale=1, elem_id='generate-stop-container'):
                        with gr.Row():
                            ...
                            shared.gradio['Generate'] = gr.Button('Submit', elem_id='Generate', variant='primary') #Genrate->SUbmit
        ...
        with gr.Column(elem_id='chat-buttons'):
            ...
            with gr.Row():
                ...
                shared.gradio['Impersonate'] = gr.Button('Impersonate (Ctrl + Shift + M)', elem_id='Impersonate',interactive=False)
        ...
        with gr.Row(elem_id='past-chats-row', elem_classes=['pretty_scrollbar']):
            with gr.Column():
                ...
                with gr.Row():
                    shared.gradio['rename_chat'] = gr.Button('Rename', elem_classes='refresh-button') #not mu
                    shared.gradio['delete_chat'] = gr.Button('🗑️', elem_classes='refresh-button') #not mu
