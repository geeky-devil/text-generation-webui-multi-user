...
def create_interface():
    ...
    title=shared.args.character+' - '+shared.args.username
    ...
    with gr.Blocks(css=css, analytics_enabled=False, title=title, theme=ui.theme) as shared.gradio['interface']:
        ...
        logout_button=ui_chat.button            #Logout
        def log_onclick():
            global logout
            #print("OOOGABOOBA")
            logout=True
        logout_button.click(log_onclick)
...
if __name__ == "__main__":
    ...
    if shared.args.nowebui:
        ...
        while True:
            ...
            if logout:
                shared.gradio['interface'].close()
                logger.info("ADIOS "+ shared.args.username)
